...
class todo:
    def __init__(self,  root):
        ...
        self.labe2=Label(self.root,text='Add Task',
              font='ariel, 18 bold',width=10,bd=5,bg='#7f3b96',fg='white')
        self.labe2.place(x=40,y=54)

        self.labe3=Label(self.root,text='Tasks',
              font='ariel, 18 bold',width=10,bd=5,bg='#7f3b96',fg='white')
        ...
        self.button = Button(self.root, text="Add", font='sarif, 20 bold italic', 
                    width=10, bd=5, bg='#0e164d', fg='white', command=add) 
        self.button.place(x=30, y=180)

        self.button2 =Button(self.root, text="Delete", font='sarif, 20 bold italic', 
                    width=10, bd=5,bg='#0e164d', fg='white', command=delete) 
